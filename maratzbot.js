...
bot.on([/(shin)(y|(ies))/i], (msg) => msg.reply.text('https://media.giphy.com/media/l4Ki2obCyAQS5WhFe/giphy.gif'));
...
bot.on(['/citoyennete'], (msg) => msg.reply.text('C\'est à propos du voyage, pas du but: YOUR_LINK'));
